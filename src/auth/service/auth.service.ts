...
import { User, CreateUserDto, UserService, UserRolesService } from '../../user';
...
export class AuthService {
  ...
  async registerUser(userData: CreateUserDto): Promise<User> {
    const userResult = await this.userService.createUser(userData);
    const userroles = await this.userRolesService.createUserRoles(userResult);
    return userResult;
